...
from .zooportal import router as zooportal_router


# "pedigree_router"
__all__ = ["dogs_router", "breedbase_router", "breedarchive_router", "huskypedigree_router", "pedigree_router", "ofa_router", "zooportal_router"]